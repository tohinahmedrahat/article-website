...
import gentalmen from '../../imges/untitled5.png'

const Follwo = () => {
    return (
        <div className="w-3/4 mx-auto mt-5">
        <h1 className="text-white text-2xl">Amazing communities to follow</h1>
        <div className="">
          <div className="mt-5 flex justify-between mb-2 bg-slate-800 p-3 rounded">
            <div className="flex items-center">
              ...
              />
              <div>
                <p className="font-semibold ml-3 text-white inline">Travel for explore</p>
                <p className="font-semibold ml-2 text-slate-400 inline">121 Stories</p>
                <p className="font-semibold ml-2 text-slate-400 inline">21 Authors</p>
